...
3. [ECS Express Mode 이전 계획](ecs-express-migration.md)
4. [운영 인수인계](operations-handoff.md)
5. [출시 점검표](release-readiness.md)
...
| [ECS Express Mode 이전 계획](ecs-express-migration.md) | 서울 ECS Express Mode 이전, 도쿄 SES 유지, DNS 전환 절차 |
