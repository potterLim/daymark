...
class DaymarkRecordWebFlowIntegrationTests extends WebFlowIntegrationTestSupport {
    ...
    void morningSaveShouldPersistDaymarkEntry() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("writer", "writer@example.com", "pass1234")
        );
        ...
        String markdownText = mDaymarkService.readEntryMarkdownContent(
            DaymarkEntryDate.of(LocalDate.of(2026, 4, 1)),
    ...
    void morningSaveShouldRejectOversizedInput() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("oversized-writer", "oversized-writer@example.com", "pass1234")
        );
    ...
    void eveningSaveShouldRejectOversizedInput() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("oversized-reviewer", "oversized-reviewer@example.com", "pass1234")
        );
    ...
    void blankMorningSaveShouldNotCreateVisibleDaymarkEntry() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("blank-writer", "blank-writer@example.com", "pass1234")
        );
    ...
    void clearingMorningSectionsShouldRemoveDaymarkEntry() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("clear-writer", "clear-writer@example.com", "pass1234")
        );
    ...
    void previewShouldOmitEmptySectionHeaders() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("preview-writer", "preview-writer@example.com", "pass1234")
        );
    ...
    void morningListShouldRenderSavedDate() throws Exception {
        ...
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("planner", "planner@example.com", "pass1234")
        );
    ...
    void eveningPageShouldRenderDirectDateSelectionWithoutWeekNavigation() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("evening-reviewer", "evening-reviewer@example.com", "pass1234")
        );
    ...
    void weekPageShouldNavigateBetweenWeeks() throws Exception {
        UserAccount userAccount = mUserAccountService.registerUserAccount(
            RegisterUserAccountCommand.createFromRawInput("week-reviewer", "week-reviewer@example.com", "pass1234")
        );
